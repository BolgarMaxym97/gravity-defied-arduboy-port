...
echo "[2/6] Стабільність фізики (евристичний бот, рівні 1 і 10)"
./headless 1  4000 | tail -6
./headless 10 4000 | tail -6

echo
echo "[3/6] Геометрія: кадрування камери і торці траси"
./camcheck

echo
echo "[4/6] Прохідність усіх рівнів (перебір, BEAM=$BEAM)"
fail=0
